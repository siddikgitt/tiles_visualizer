...
import trapShapeModal from "../../images/chooseSpace/Trapezoid_Shape_Modal.png";
import { useNavigate } from "react-router-dom";

const TrapShapeModal = ({ isOpen, onClose }) => {
      ...
      <Modal size={"2xl"} isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <Text textAlign={"center"} color={"rgba(51, 51, 51, 0.7)"} fontSize={"16px"}>
            ...
            <Flex mt={2} >
              <Box w={"50%"}>
              <Image src={trapShapeModal} />
              </Box>
              <Box w={"50%"} margin={"auto"}>
                <SimpleGrid columns={2} spacing={5}>
                  <Flex gap={2} alignItems={"center"}>
                    <Text>A</Text>
                    <Input border={"1px solid rgba(167, 165, 165, 1)"} w={"149px"} type="number"/>
                  </Flex>
                  <Flex gap={2} alignItems={"center"}>
                    <Text>B</Text>
                    <Input border={"1px solid rgba(167, 165, 165, 1)"} type="number"/>
                  </Flex>
                  <Flex gap={2} alignItems={"center"}>
                    <Text>C</Text>
                    <Input border={"1px solid rgba(167, 165, 165, 1)"} type="number"/>
